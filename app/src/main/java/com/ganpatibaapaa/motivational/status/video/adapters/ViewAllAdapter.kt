...
class ViewAllAdapter(var list: ArrayList<Video>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    lateinit var context: Context
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        context = parent.context
        return ViewAllCardViewHolder(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        val titleCardViewHolder = holder as ViewAllCardViewHolder
        Glide.with(context)
        ...
        titleCardViewHolder.cardView.setOnClickListener{
            ...
            intent.putExtra("LoadedVideo", list.size)
    ...
    inner class ViewAllCardViewHolder(view: View) : RecyclerView.ViewHolder(view) {
